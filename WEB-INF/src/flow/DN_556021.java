 ...
 */
public class DN_556021 extends com.avaya.sce.runtime.Form {
...
>>>>>>> 1ce24f429fccbcab12844b062c4f9e73875b8a9b
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("inputVouncherNum", "1.0"));


		// build events for the field: "DN_556021"
		events = new java.util.ArrayList(2);

		// Item has no prompts associated
		eventPromptNames = new java.util.ArrayList();

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("Disconnect", 3, true, ""));
		events.add(event);

		// Item has no prompts associated
		eventPromptNames = new java.util.ArrayList();

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("Disconnect", 3, true, ""));
		events.add(event);
		properties = new java.util.ArrayList();

		nbest = 1;
		field = new com.avaya.sce.runtime.Field("DN_556021", false, true, grammarInfo, promptNames, events, properties, nbest, true, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
...
>>>>>>> 1ce24f429fccbcab12844b062c4f9e73875b8a9b
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Voice_556021", ""));
...
>>>>>>> 1ce24f429fccbcab12844b062c4f9e73875b8a9b
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("assignTenantID");
		return submit;
	}
	/**
...
>>>>>>> 1ce24f429fccbcab12844b062c4f9e73875b8a9b
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_INFO, "###偵測公司代碼輸入為###", "DN_556021:utterance"));
		return(list);
	}
	/**
...
>>>>>>> 1ce24f429fccbcab12844b062c4f9e73875b8a9b
	 ...
	 * This method should not be manually edited as changes may be
<<<<<<< HEAD
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2024年11月22日 下午06時05分37秒
=======
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2024年11月22日 下午05時44分50秒
>>>>>>> 1ce24f429fccbcab12844b062c4f9e73875b8a9b
	 */
