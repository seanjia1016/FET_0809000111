 ...
 * Last generated by Orchestration Designer at: 2017年6月30日 上午10時05分55秒
 */
public class MN_016008 extends com.avaya.sce.runtime.Menu {
	 ...
	 * Last generated by Orchestration Designer at: 2018年6月5日 下午04時26分24秒
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("*", "*", true, "exact", "CF_DonationToRedCrossByPhone-Get_015708", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Voice_015708", ""));
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Voice_881008", ""));
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Voice_888099", ""));
