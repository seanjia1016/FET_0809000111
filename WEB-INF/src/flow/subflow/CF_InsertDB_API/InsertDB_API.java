package flow.subflow.CF_InsertDB_API;
...
import com.infotrends.DBfunction.ResolveDB_Update_API;
 ...
 * Last generated by Orchestration Designer at: 2017年7月20日 下午02時17分42秒
 */
public class InsertDB_API extends com.avaya.sce.runtime.BasicServlet {
	...
	public void servletImplementation(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		String url = "http://"+IP+"/CommonDBAPI/doInsert"; //作業
...
//			wr.writeBytes(urlParameters);
		...
		ResolveDB_Update_API resolveDBAPIin = new ResolveDB_Update_API();
		
		mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_INFO, "ResponseJsonObject Response:" +ResponseJsonObject);
		
		

		 if(TABLE.equals("FE_API_LOG_TBL")){
			resolveDBAPIin.FE_API_LOG_TBL(mySession, ResponseJsonObject);
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("CF_InsertDB_API-Back", 0, true, "Default");
		list.add(aGoto);
