		...
		try {
            ...
            if (responseJsonObject.has("Data") && responseJsonObject.getJSONObject("Data").has("xml-fragment")) {
                ...
                if (xmlFragment.has("ns0:voucherList")) {
                    ...
                    msisdn = voucherList.optJSONObject("ns1:msisdn").optString("content", "");
                    seqNo = voucherList.optJSONObject("ns1:seqNo").optString("content", "");
                    value = voucherList.optJSONObject("ns1:value").optString("content", "");
         ...
         // 取得dbip
            ...
            ResponseJsonObject.put("msisdn",msisdn);
            ResponseJsonObject.put("value",value);
			...
			if (ResponseJsonObject.has("bdip")) {
				bdip = ResponseJsonObject.getString("bdip");
			    Utils.setFieldString(mySession,
			...
			Utils.LogsINFO(mySession, "returnCode (TID:["+TID+"]"+apiName+"):" +returnCode);
			    ...
			    if (ResponseJsonObject.has("msisdn")) {
			    	msisdn = ResponseJsonObject.getString("msisdn"); // 取得 msisdn 的值
			        Utils.setFieldString(mySession,
			                IProjectVariables.QUERY_VOUCHER_CARD_SERVICE__OUTPUT,
			                IProjectVariables.QUERY_VOUCHER_CARD_SERVICE__OUTPUT_FIELD_MSISDN,
			                msisdn);
			    }
			    Utils.LogsINFO(mySession, "msisdn (TID:["+TID+"]"+apiName+"):" +msisdn);
			    
			    if (ResponseJsonObject.has("value")) {
			    	value = ResponseJsonObject.getString("value"); // 取得 value 的值
			        Utils.setFieldString(mySession,
			                IProjectVariables.QUERY_VOUCHER_CARD_SERVICE__OUTPUT,
			                IProjectVariables.QUERY_VOUCHER_CARD_SERVICE__OUTPUT_FIELD_VALUE,
			                value);
			    }
			    Utils.LogsINFO(mySession, "value (TID:["+TID+"]"+apiName+"):" +value);
			    ...
			    if (returnCode.equals("ESB-006-029-01000")) {
			    	Utils.setFieldString(mySession,
			                IProjectVariables.TASK___0_8_0_9_0_0_0_8_1_1__TBL,
