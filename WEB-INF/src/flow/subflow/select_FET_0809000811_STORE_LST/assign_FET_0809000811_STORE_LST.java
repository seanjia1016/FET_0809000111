...
public class assign_FET_0809000811_STORE_LST extends com.avaya.sce.runtime.BasicServlet {
	...
	public void servletImplementation(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		//5G修改?���?
		String SQL= "SELECT ANI	MSISDN,REQ_DATE	REQ_TIME,S_TIME,E_TIME,voucherNumber,voucherPinCode,JOB,REASON,RET_CODE,STATUS,AMT,BPID,ENTERPRISE,OUT_VDN " + 
				" FROM FET_0809000811_STORE_LST WHERE ENTERPRISE = '"+ tenantID +"' ";
	 ...
	 * Last generated by Orchestration Designer at: 2024�?11???6?�� 下�??12???16???57�?
	 */
