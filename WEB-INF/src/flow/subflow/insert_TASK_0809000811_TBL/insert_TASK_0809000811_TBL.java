...
public class insert_TASK_0809000811_TBL extends com.avaya.sce.runtime.BasicServlet {
	...
	public void servletImplementation(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		String status = Utils.getFieldString(mySession, IProjectVariables.TASK___0_8_0_9_0_0_0_8_1_1__TBL,
		...
		String value = Utils.getFieldString(mySession, IProjectVariables.QUERY_VOUCHER_CARD_SERVICE__OUTPUT,
				IProjectVariables.QUERY_VOUCHER_CARD_SERVICE__OUTPUT_FIELD_VALUE);
		
		Utils.LogsINFO(mySession, "value (TID:["+TID+"]"+"TASK_0809000811_TBL"+"):" +value);

		String insert_TASK_0809000811_TBL = "insert TASK_0809000811_TBL";

		String SQL = "INSERT INTO TASK_0809000811_TBL (ANI, MSISDN, REQ_DATE, REQ_TIME, REQ_STIME, REQ_ETIME, voucherNumber, voucherPinCode, JOB, REASON, RET_CODE , STATUS , AMT , BPID , ENTERPRISE , OUT_VDN)"
