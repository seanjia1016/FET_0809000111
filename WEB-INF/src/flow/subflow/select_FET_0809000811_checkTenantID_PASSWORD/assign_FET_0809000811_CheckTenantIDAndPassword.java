...
public class assign_FET_0809000811_CheckTenantIDAndPassword extends com.avaya.sce.runtime.BasicServlet {
	...
	public void servletImplementation(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		IVariable ICCardVarible = mySession.getVariable(IProjectVariables.VOICE___5_5_6_0_2_4);
		IComplexVariable complexICCardVarible = ICCardVarible.getComplexVariable();
		
		IVariableField ICCardfield = complexICCardVarible.getField(IProjectVariables.VOICE___5_5_6_0_2_4_FIELD_UTTERANCE);
		...
		mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_INFO, "SQL Response(["+TID+"]"+Select_TASK_0809000811_TBL+"):" +SQL);
		...
		mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_INFO, "Table Response(["+TID+"]"+Select_TASK_0809000811_TBL+"):" +Table);
