 ...
 */
public class MN_015626 extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("1", "1", true, "exact", "CF_DonationToChildWelfareLeague-Get_015626", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Voice_015624", ""));
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Voice_015626", ""));
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Voice_015625", ""));
