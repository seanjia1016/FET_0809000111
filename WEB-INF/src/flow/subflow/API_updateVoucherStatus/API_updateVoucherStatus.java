...
public class API_updateVoucherStatus extends com.avaya.sce.runtime.BasicServlet {
	...
	private String buildParam(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		String pinCode = Utils.getFieldString(mySession, IProjectVariables.QUERY_VOUCHER_CARD_SERVICE__OUTPUT, IProjectVariables.QUERY_VOUCHER_CARD_SERVICE__OUTPUT_FIELD_PIN_CODE);
		String subscriberNumber = Utils.getFieldString(mySession, IProjectVariables.GET_CASH_SUBSCRIBER_INFO_BY_KEY__INPUT, IProjectVariables.GET_CASH_SUBSCRIBER_INFO_BY_KEY__OUTPUT_FIELD_SUBSCRIBER_ID);
		String voucherNumber = Utils.getFieldString(mySession, IProjectVariables.QUERY_VOUCHER_CARD_SERVICE__OUTPUT, IProjectVariables.QUERY_VOUCHER_CARD_SERVICE__OUTPUT_FIELD_VOUCHER_NUMBER);
		String seqNO = Utils.getFieldString(mySession, IProjectVariables.QUERY_VOUCHER_CARD_SERVICE__OUTPUT, IProjectVariables.QUERY_VOUCHER_CARD_SERVICE__OUTPUT_FIELD_SEQ_NO);
		String bdip = Utils.getFieldString(mySession, IProjectVariables.GET_CASH_SUBSCRIBER_INFO_BY_KEY__INPUT, IProjectVariables.GET_CASH_SUBSCRIBER_INFO_BY_KEY__INPUT_FIELD_TRANS_BP_ID);
