 ...
 */
public class AN_015604 extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Voice_015604", ""));
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Voice_015603_2_ID", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("CF_InputAndCheckID-MN_015605_2_MenuID");
		return submit;
	}
	/**
