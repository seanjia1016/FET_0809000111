 ...
 * Last generated by Orchestration Designer at: 2017年6月27日 下午06時47分26秒
 */
public class MN_015605_2 extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("1", "1", true, "exact", "CF_InputAndCheckID-Get_015605_2", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("2", "2", true, "exact", "CF_InputAndCheckID-Get_015605_2", grammarInfo, true);
		list.add(choice);
