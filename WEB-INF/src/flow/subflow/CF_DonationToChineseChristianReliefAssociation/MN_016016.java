 ...
 * Last generated by Orchestration Designer at: 2017年6月26日 下午06時49分52秒
 */
public class MN_016016 extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("1", "1", true, "exact", "CF_DonationToChineseChristianReliefAssociation-Get_016016", grammarInfo, true);
		list.add(choice);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("Voice_016016", ""));
