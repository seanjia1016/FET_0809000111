...
public class insert_IVR_DONATE_TRAN extends com.avaya.sce.runtime.BasicServlet {
	...
	public void servletImplementation(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		String insert_IVR_DONATE_TRAN = "insert IVR_DONATE_TRAN";
		...
		String SQL = "INSERT INTO IVR_DONATE_TRAN (DONATE_CD, MSISDN, DONATE_DATE, DONATE_AMT, CYCLY_DATE, BUSINESS_ENTITY)" + 
					 "VALUES ('" + DONATE_CD + "', '"+ ani +"', '"+ApiReqDate+"', '" + selectAmount + "', '', '" + subType + "')";
	 ...
	 * Last generated by Orchestration Designer at: 2017年10月16日 下午03時13分48秒
	 */
