 ...
 */
public class DN_556024 extends com.avaya.sce.runtime.Form {
...
>>>>>>> 1ce24f429fccbcab12844b062c4f9e73875b8a9b
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("Voice_556024", ""));

		// build the list of grammar information objects for the field
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("InputICCard", "1.0"));


		// build events for the field: "DN_556024"
		...
		nbest = 1;
		field = new com.avaya.sce.runtime.Field("DN_556024", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
...
>>>>>>> 1ce24f429fccbcab12844b062c4f9e73875b8a9b
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("DN_556025");
		return submit;
	}
	/**
