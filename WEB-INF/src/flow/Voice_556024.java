 ...
 */
public class Voice_556024 extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("ReInputPhoneNumber", "1.0", "Chinese"));


		// build events for the field: "Voice_556024"
		...
		nbest = 1;
		field = new com.avaya.sce.runtime.Field("Voice_556024", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Voice_556025");
		return submit;
	}
	/**
