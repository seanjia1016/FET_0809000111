...
public class DN_556032 extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("void", "1", true, "exact", "DN_556034", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("requery", "#", true, "exact", "DN_556024", grammarInfo, true);
		list.add(choice);
