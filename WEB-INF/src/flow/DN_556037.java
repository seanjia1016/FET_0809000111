...
public class DN_556037 extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("KeepQuerying", "#", true, "exact", "DN_556024", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("ToAgent", "0", true, "exact", "DN_556036_1", grammarInfo, true);
		list.add(choice);
