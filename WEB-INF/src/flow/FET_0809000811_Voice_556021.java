 ...
 */
public class FET_0809000811_Voice_556021 extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 2024年11月6日 下午02時31分25秒
	 */
	public FET_0809000811_Voice_556021() {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("Voice_556021", ""));

		// build the list of grammar information objects for the field
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("inputTenantID", "1.0"));


		// build events for the field: "FET_0809000811_Voice_556021"
		...
		nbest = 1;
		field = new com.avaya.sce.runtime.Field("FET_0809000811_Voice_556021", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "####輸入的公司代碼####", "FET_0809000811_Voice_556021:utterance"));
		return(list);
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2024年11月14日 下午01時09分34秒
	 */
