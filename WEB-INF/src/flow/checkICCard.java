	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "getCashSubscriberInfoByKey_Output:returnCode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "ESB-006-029-01000", false).setDebugId(2068)).evaluate(mySession)) {
			...
			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "queryVoucherCardService_Output:status", com.avaya.sce.runtime.Expression.STRING_EQUAL, "USED", false).setDebugId(1828)).evaluate(mySession)) {
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.Next("DN_556027", "ERROR").setDebugId(1833));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("DN_556027", "ReturnCodeIsWrong").setDebugId(2072));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
