...
public class get_CallInfo extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("TASK_0809000811_TBL:ani", "cticallinfo:ani", false).setDebugId(2165));
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("TASK_0809000811_TBL:msisdn", "cticallinfo:ani", false).setDebugId(2166));
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("TASK_0809000811_TBL:req_date", "date:audio", false).setDebugId(2167));
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("TASK_0809000811_TBL:req_time", "time:audio", false).setDebugId(2168));
		if(evaluateActions(actions, mySession)) {
			return true;
		}
		actions = null;
