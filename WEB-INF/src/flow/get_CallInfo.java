...
public class get_CallInfo extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("insertStartDate", "date:audio", false).setDebugId(2147));
		actions.add(new com.avaya.sce.runtime.varoperations.Assign("insert_StartTime", "time:audio", false).setDebugId(2148));
